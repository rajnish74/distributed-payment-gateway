...
public class WebhookDeliverySchedular {
    ...
    @SchedulerLock(name = "opeartions-service-webhook-delivery-poll-and-deliver", lockAtMostFor = "10s", lockAtLeastFor = "1s")
    ...
    @SchedulerLock(name = "opeartions-service-webhook-delivery-reconcile-from-db", lockAtMostFor = "10s", lockAtLeastFor = "1s")
